...
<html>
  ...
  <div>
    ...
    <td><input type="submit" id="bt21" onclick="edlist.action='/edms/searchempower';return check(form);" value="搜索"/></td>
    <td><input type="submit" id="bt20" value="返回" onclick="edlist.action='/edms/usermenu';"></td>
    </tr>
    </table>
    <table>
    <tr><td>授权文件</td></tr>
    ...
    <td><input type="button" id="bt27" value="授权" onclick="edlist.action='/edms/setempower/${ueitem.getNo()}/${uid}';
    			edlist.submit();"></td>
    </tr>
    </c:forEach>
    </table>
